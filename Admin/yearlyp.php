                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4><?php  if(isset($_POST['Search']) && isset($_POST['year'])) {                                     
                                            $year=$_POST['year'];
                                            ?> Purchase Plan Report of  Year <?php if(isset($year)){echo $year;}?> </h4>
											<?php }?>
                                    </div>
                                    <div class="widget-body">
                                        <div class="table-responsive">
                                            ...
                                            $year=$_POST['year'];
                                                    $sql = "SELECT *,vp.status as pstatus,date(vp.create_at) as cdate FROM venue_plan vp,tbl_venue tv,tbl_vendor td,subscription_plan sp where td.vendor_id=vp.venue_id and tv.vendor_id=vp.venue_id and vp.plan_id=sp.plan_id  and year(vp.create_at)= '$year' and vp.payment_status= 'TXN_SUCCESS' order by id asc";
