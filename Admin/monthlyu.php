                        ...
                        <div class="row">
                            <div class="page-header">
                                ...
                                <a href="dashboard.php">Dashboard</a> &nbsp;/&nbsp; 
                                        ...
                                        <a href="monthlyu.php" style="color:red"> Monthly</a>&nbsp;/&nbsp;
                            ...
                            <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4> <?php  if(isset($_POST['Search']) && isset($_POST['month'])) {                                     
                                            $month=$_POST['month'];
                                            ?> User Report of  Month <?php if(isset($month)){echo $month;}?> </h4>
											<?php }?>  
											</div>
                                    <div class="widget-body">
                                        <div class="table-responsive">
                                          ...
                                          if(isset($_POST['month']) && isset($_POST['Search'])) { 
												$month=$_POST['month'];
												$sql = "SELECT *,date(created_at) as cdate FROM register_user where month(created_at)='$month' order by user_id";
                                            //echo $sql;
