                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
                                        ...
                                        <a href="monthlyp.php" style="color:red"> Monthly</a>&nbsp;/&nbsp;
                                        <a href="yearlyp.php"> Yearly</a>&nbsp;/&nbsp;
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4> <?php  if(isset($_POST['Search']) && isset($_POST['month'])) {                                     
                                            $month=$_POST['month'];
                                            ?> Purchase Plan Report of  Month <?php if(isset($month)){echo $month;}?> </h4>
											<?php }?> 
                                    </div>
                                    <div class="widget-body">
                                        <div class="table-responsive">
                                            <table id="export-table" class="table mb-0">
												...
												$month=$_POST['month'];
                                                    $sql = "SELECT *,vp.status as pstatus,date(vp.create_at) as cdate FROM venue_plan vp,tbl_vendor td,tbl_venue tv,subscription_plan sp where td.vendor_id=vp.venue_id and tv.vendor_id=vp.venue_id and vp.plan_id=sp.plan_id  and month(vp.create_at)= '$month' and vp.payment_status='TXN_SUCCESS' order by id asc";
