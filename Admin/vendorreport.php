                            ...
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
                                       <a href="dashboard.php">Dashboard</a> &nbsp;/&nbsp; 
                                        <a href="vendorreport.php" style="color:red"> Vendor Report</a>&nbsp;/&nbsp;
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow" style="width: 1150px">
                                    <div style="background-color:cornflowerblue"><br>
                                        <h2 align="center"> Vendor Report</h2><hr>
                                    </div>
                                    </div>
                                    <div class="widget-body">
                                        <div class="table-responsive">
                                            <table id="export-table" class="table mb-0">
                                                ...
                                                <?php 
                                                    $sql = "SELECT *,date(td.created_at) as cdate FROM tbl_vendor td order by td.vendor_id";
