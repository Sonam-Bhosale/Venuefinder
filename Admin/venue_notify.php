                        ...
                        <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
                                        ...
                                        <a href="venue_notify.php" style="color:red" class="page-header-title"> View Vendor Notification</a>
    	                        </div>
                            </div>
                        </div>
                        <!-- End Page Header -->
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow" style="width: 1150px">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4>Registerd Vendor Itself Notification</h4>
                                    </div>
                                    <div class="widget-body">
                                        <div class="table-responsive">
                                            <table id="sorting-table" class="table mb-0">
                                                ...
                                                <?php 
                                                    $sql = "SELECT *,date(td.created_at) as date1 FROM tbl_vendor td,notification noti where 
                                                    noti.id=td.vendor_id  and noti.notification='Vendor'  and td.status='Deactive' order by  noti.notification_id desc";
