                    ...
                    <span class="directory-results-bar-results"><?php echo $count;?> results:</span>
                        <ul class="directorySearch">
                            <li class="directorySearch__tag app-directory-filters-change" data-filters-remove="id_sector[],faqs[],popularPriceRange[],capacityRange" data-value="3">
                                            <span class="directorySearch__label">Venues List</span>
        ...
        <div id="app-vendors-directory-result-list" class="directory-structure-content">
            <div class="directory-list">
                ...
                <?php 
                         ...
                         //$sql="select *,tv.venue_id as vid from tbl_venue tv,tbl_vendor td,venue_details vd,venue_plan vp where tv.city='satara' and td.vendor_id=vd.venue_id and td.vendor_id=tv.vendor_id and td.status='Active' and vp.venue_id=td.vendor_id and vp.status='Active' order by rand()";
                        $result=$connect->query($sql);
                            if ($result->num_rows > 0) 
                            {
                                while($row = $result->fetch_assoc()) 
                ...
                ?>        
                            ...
                            <div class="pure-u-1-3">
                                    <div class="vendor-slider">
                                        <div class="vendor-slider-content img-zoom">                                                 
                                            <img class="app_lnkEsc_267003  pointer"src="controller/uploads/logo/<?php echo $row['logo']; ?>" width='200px' height="50px" >
                                        </div>
                                    </div>
                            </div>
                            <div class="pure-u-2-3">
                                <div class="directory-item-content">
                                    <a id="app_lnkEmp_274911" class="item-title app-ec-click app_lnkEsc_267003" href="viewvenue.php?id=<?php echo $row['user_id'];?> "><?php echo $row['venue_name']; ?></a>
                                    ...
                                    <p class="item-desc">
                                     <?php 
                                            echo $name.' is a venue available for hosting your wedding. When it comes to finalising your venue, an <span>...</span>  ';
                                        ?>     
                                </p>
                                    <div class="listItem">
                    ...
                    echo "<h1 align='center'>No Any Venue Available !!</h1>";
                }   ?> 
                    </div>                   
            </div>
        </div>
