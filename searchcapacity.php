...
<div id="app-vendors-directory-heading-navigation">
    <div id="app-vendors-directory-navigation" class="directory-results-bar">
        ...
        <?php 
            $size=$_POST['capacity'];
            $sql="select td.vendor_id,count(vd.venue_id) as count,tv.venue_id as vid from tbl_venue tv,tbl_vendor td,venue_details vd,venue_plan vp where tv.city='satara' and td.vendor_id=vd.venue_id and vd.seating_capacity >= '$size' and td.vendor_id=tv.vendor_id and td.status='Active' and vp.venue_id=td.vendor_id and vp.status='Active' ";

           // $sql="select *,count(tv.venue_id) as count from tbl_venue tv,tbl_vendor td,venue_plan vp,venue_details vd where tv.city='Satara' and td.status='Active' and vp.venue_id-td.vendor_id and td.vendor_id=tv.vendor_id and vp.status='Active' and vd.venue_id=tv.vendor_id and vd.seating_capacity >= '$size' ";
...
<div class="wrapper">
    <div class="directory-structure clearfix">
        <div id="app-vendors-directory-result-list" class="directory-structure-content">
			...
			$size=$_POST['capacity'];
            $sql="select *,tv.venue_id as vid from tbl_venue tv,tbl_vendor td,venue_details vd,venue_plan vp where tv.city='satara' and td.vendor_id=vd.venue_id and vd.seating_capacity >= '$size' and td.vendor_id=tv.vendor_id and td.status='Active' and vp.venue_id=td.vendor_id and vp.status='Active' order by rand()";
            $result=$connect->query($sql);
                if ($result->num_rows > 0) 
                {
                    while($row = $result->fetch_assoc()) 
                        ...
                        <div class="pure-u-1-3">
                                <div class="vendor-slider">
                                    ...
                                    <div class="vendor-slider-content img-zoom">                                                 
                                        <img class="app_lnkEsc_267003  pointer" width="200px" height="80px" src=" controller/uploads/banner/<?php echo $banner; ?>" >
                                    </div>
                                </div>
                         </div>
							...
							<!----search by price--->
							 ...
							 <div class="vendorsFilters__section">
                                <div class="app-filter-vendors">
                                        ...
                                        <!-- <div data-name="sector" data-input="id_sector"> -->
										 <div>
											Min Value:<input type="" placeholder="Minimum Value" class="pure-u-1"id="min" name="min_price" value="">
											<div id="slider-range"></div>
											Max Value:<input type="" id="max" placeholder="Maximum Value" class="pure-u-1" name="max_price" value="">
											<input type="submit" name="submit_range"  value="Filter Product" style="background-color:blue" class="btn-flat red mt10 pure-u-1">
										</div>
										<!-- </div> -->
                                </div>
                            </div>
                            ...
                            <!---End---->
							 ...
							 <div class="vendorsFilters__section">
                                <div class="app-filter-vendors">
                                        ...
                                        <!-- <div data-name="sector" data-input="id_sector"> -->
										 <div>
											Capacity :<input type="text" class="pure-u-1" placeholder="Seating Capacity" name="capacity" value="<?php echo $size;?>">
											<div id="slider-range"></div>	
