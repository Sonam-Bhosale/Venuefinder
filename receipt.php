...
<body style="margin: 0; padding: 0;">
        ...
        <tr>
            <td bgcolor="#f2f3f8" align="center">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                        <td align="center"><a href="booking.php"><i class="la la-back la-5x"></i> <h3>GO BACK</h3> </a></td>
                                    ...
                                    <td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                            <tr>
                                                ...
                                                Status : <?php echo $status;?><br><br><br>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="47%" align="right" class="responsive-table">
                                            <tr>
                                                <td style="padding: 20px 15px 0 0;">
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tr>
                                                            <td align="right" style="padding: 10px 0 20px 0 ; font-family: Noto Sans, Arial, sans-serif; color: #2c304d; font-size: 15px; line-height: 20px; border-top: 2px solid #eee;">
	...
	<tr>
		...
		<script Language="Javascript">
			...
			if (VERSION > 3)
			{
				document.write('<form> <input type=button value="Print" style="background-color:red;font-size:18px" name="Print" onClick="printit()"> </form>');
			}
		</script>
		</td>
	</tr>
</table>
                            <!-- <h2 align="center"><input type="submit" style="background-color:red" value="Print" ></h2> -->
                        </td>
                    </tr>
                </table>
            </td>
