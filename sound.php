        ...
        <div class="wrapper">
            ...
            <div class="pure-g va-flex-end">
                <div class="pure-u-4-6">
                    ...
                    <span class="directory-results-bar-results"><?php echo '1';?> results:</span>
                        <ul class="directorySearch">
                            <li class="directorySearch__tag app-directory-filters-change" data-filters-remove="id_sector[],faqs[],popularPriceRange[],capacityRange" data-value="3">
                                            <span class="directorySearch__label">Sound System Planner List</span>
                            ...
                            <div class="pure-u-1-3">
                                    <div class="vendor-slider">
                                        <div class="vendor-slider-content img-zoom">                                                 
                                            <img class="app_lnkEsc_267003  pointer"src="controller/uploads/logo/tushar.jpg" width='280px' height="50px" >
                                        </div>
                                    </div>
                            </div>
                            <div class="pure-u-2-3">
                                <div class="directory-item-content">
                                    <a id="app_lnkEmp_274911" class="item-title app-ec-click app_lnkEsc_267003" href=""><?php echo 'Tushar DJ SOUND AND Services '; ?></a>
                                
                                    <div class="item-subtitle">
                                                        <span><?php echo 'at post godoli, near police line build no. 22, Godoli, Satara - 415002'; ?></span>
                                    </div>
                                    <p class="item-desc">
                                    Tushar DJ SOUND AND Services in Satara is one of the leading businesses in the Mandap Decorators. Also known for Mandap Decorators, Event Organisers, Event Management Companies, Flower Decorators, Wedding Decorators, Event Organisers For Wedding, Lighting Decorators, Stage Decorators and much more.   
                                </p>
                                    <div class="listItem">
                                        <div class="listItem__features">                
                                                <div class="listItem__featuresUnit">
                                                    <span class="listItem__featuresName">Phone Number</span>
                                                    <i class="fa fa-phone"></i><?php echo '+91-9595957363';?>
                                                </div>
