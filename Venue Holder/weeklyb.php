                            ...
                            <div class="col-xl-11">
								 <div class="page-header pr-0 pl-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="weeklyb.php" style="color:red"> Weekly</a>&nbsp;/&nbsp;
                        ...
                        <div class="row">
                            ...
                            <div class="widget has-shadow">
                                    <div style="background-color:cadetblue" ><br>
                                        <h2 align="center"> Weekly Booking Report</h2><hr>
                                    </div>
                                    <div class="widget-body">
                                        <div class="table-responsive">
                                            <table id="export-table" class="table mb-0">
												...
												$sql = "SELECT *,date(bv.created_at) as cdate FROM register_user u,book_venue bv, payment p where p.bookid=bv.book_id and p.payment_status='TXN_SUCCESS' and p.txn_id=bv.transaction_id and bv.user_id=u.user_id and bv.vendor_id='$id' and YEARWEEK(bv.created_at) = YEARWEEK(NOW()) order by book_id";
												//echo $sql;
