                    ...
                    <div class="container-fluid">
                        ...
                        <form method="post" enctype="multipart/form-data">
								...
								<tr>
									<td><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter Year:&nbsp;</label></td>
									<td><input type="year" name="year" placeholder="yyyy"></td>
                            ...
                            <div class="widget has-shadow">
                                    <div style="background-color:cadetblue" class="widget-header bordered no-actions d-flex align-items-center">
                                        <h4><?php  if(isset($_POST['Search']) && isset($_POST['year'])) {                                     
                                            $year=$_POST['year'];}
                                            ?> Booking Report of  Year <?php if(isset($year)){echo $year;}?> </h4>
                                    ...
                                    <div class="widget-body">
                                        <div class="table-responsive">
                                            <table id="export-table" class="table mb-0">
                                                ...
                                                <?php if(isset($_POST['year']) && isset($_POST['Search'])) { 
													$id=$_SESSION['venue_id'];
												$sql = "SELECT *,date(bv.created_at) as cdate FROM register_user u,book_venue bv,payment p where p.bookid=bv.book_id and p.payment_status='TXN_SUCCESS' and p.txn_id=bv.transaction_id and bv.user_id=u.user_id and bv.venue_id='$id' and year(bv.created_at) = '$year' order by book_id";
												//echo $sql;
