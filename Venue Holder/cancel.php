                            ...
                            <div class="col-xl-11">
                                ...
                                <div class="page-header pr-0 pl-0">
                                    ...
                                    <a href="booking_order.php">Booking List&nbsp;|&nbsp;</a>
                                        ...
                                        <a href="cancel.php" style="color:red">Canceled Booking</a>&nbsp;|&nbsp;
                                ...
                                <div class="row">
                                    ...
                                    <div style="background-color:cornflowerblue"><br>
                                     <h2 align="center" style="color:white">Cancel Booking Report </h2><hr>
                                    </div>
                                ...
                                $sql="select *,register_user.name as customer_name from book_venue,register_user,payment where payment_status='TXN_SUCCESS' and payment.txn_id=book_venue.transaction_id and  book_venue.vendor_id='$venue_id' and book_venue.user_id=register_user.user_id and book_venue.event_status='Canceled' order by book_id desc";
